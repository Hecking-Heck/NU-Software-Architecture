...
function climateData() {  
    ...
    $year["2023"] = array("jan"=>4.4, "feb" =>5.8, "mar"=>5.7, "apr"=>7.8,"may"=>11.6, "jun"=>15.8, "jul"=>15.0, "aug"=>15.3, "sep"=>15.2, "oct"=>10.7, "nov"=>6.3, "dec"=>5.8, "av"=>9.97);
    $year["2024"] = array("jan"=>3.8, "feb" =>6.3, "mar"=>6.7, "apr"=>8.3,"may"=>13.1, "jun"=>12.9, "jul"=>14.8, "aug"=>15.4, "sep"=>12.7, "oct"=>10.4, "nov"=>6.6, "dec"=>6.2, "av"=>9.78);
